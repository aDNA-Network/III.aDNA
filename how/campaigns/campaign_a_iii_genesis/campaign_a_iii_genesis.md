...
- [ ] `how/airlock/AIRLOCK.md` implemented (5 entry paths minimum) (MA-4)
...
| **MA-3** | Module decomposition: 8 module .md + .module.yaml files | 1-2 | NEXT |
...
| P2 | Module Architecture + Airlock (MA-3, MA-4) | ⚙ IN PROGRESS — MA-3 next |
