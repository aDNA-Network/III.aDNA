...
files_modified:
  ...
  - ../CLAUDE.md (workspace router at /Users/stanley/aDNA/CLAUDE.md)        # III.aDNA row reflects MD-B5 closed + MD-B6 sole remaining
---
...
- `~/aDNA/CLAUDE.md` workspace router (III.aDNA row; out-of-repo — `~/aDNA` not a git repo, persists on disk uncommitted)
