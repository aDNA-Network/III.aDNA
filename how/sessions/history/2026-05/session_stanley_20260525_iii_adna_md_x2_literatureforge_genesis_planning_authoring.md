...
files_modified:
  ...
  - ../CLAUDE.md (workspace router at /Users/stanley/aDNA/CLAUDE.md)        # III.aDNA row light forward-ref (LiteratureForge planning queued)
---
...
- `~/aDNA/CLAUDE.md` (workspace router — light forward-reference in III.aDNA row)
