...
| Campaign D: Federation-Aware Airlock v0.3 + RLHF/Adaptive Loop | D1 federation-aware airlock v0.3 (LOAD-BEARING on `LatticeNetwork.aDNA` pc_01 Phase A + Phase B1 dual-substrate) + D2 RLHF + adaptive-improvement loop | **DG-D 7/11** — chartered 2026-05-20; MD-B1 ✅ 2026-05-20 (`b1f1bc4` adaptive loop spec + ADR-005 RLHF + ADR-007 loop architecture); MD-B2 ✅ 2026-05-21 (VFL graduation; canonical md5 rotated `dde2cbd8` → `5adb0dfa`; ADR-003 §3.6; canonical 26 → 28 entries / 5 graduated); MD-A1 ✅ 2026-05-21 (spec v0.3 federation-substrate awareness); MD-A2 ✅ 2026-05-21 (substrate impl v0.3 Ed25519 + ledger observation + COMPLIANCE_AUDIT); MD-A3 ✅ 2026-05-22 (activation kit; AIRLOCK.md reference instance v0.3.0); MD-A4 ✅ 2026-05-22 (5 consumer wrappers minor-bump v0.2 → v0.3; lattice-labs/iii v0.1.0 formally tracked-deferred); **MD-B3 ✅ 2026-05-23** (cross-vault RLHF aggregation contract — NEW ADR-008 [boundary-crossing field set resolves adaptive-loop spec §5.3 + ≥2-vault aggregation feeds ADR-003 §3.6; transport = learning_store_graduation cross_vault_request over v0.3 airlock §4.3] + NEW `template_cross_vault_graduation_proposal.md` formalizing VFL memo; both specs' forward-refs RESOLVED no version bump; lattice yaml 1.2.4; ZERO graduation — canonical md5 `5adb0dfa` invariant); MD-B4 + MD-A5 + MD-B5 + MD-B6 pending |
