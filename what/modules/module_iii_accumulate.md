...
fair:
  ...
  interoperable:
    ...
    standards: ["aDNA Module Spec v1.0", "III Review Skill v1.0", "ADR-003 Graduation Protocol"]
  reusable:
    license: "Apache-2.0"
...
| `graduation_signals` | structured | Corrections meeting `frequency ≥ 3` AND `acceptance_rate ≥ 80%` — flagged for ADR-003 ceremony |
