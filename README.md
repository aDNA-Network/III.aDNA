...
Click **[Use this template](https://github.com/LatticeProtocol/Agentic-DNA/generate)** on GitHub to create your own copy with clean history. Clone the result into `~/aDNA/`.
